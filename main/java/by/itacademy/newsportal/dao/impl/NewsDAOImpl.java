...
public class NewsDAOImpl implements NewsDAO {
    ...
    private static final String GET_COUNT_NEWS = "SELECT count(*) FROM news WHERE status='approved'";
    ...
    @Override
    public void delete(int[] massIdNews) throws DAOException {
    ...
    @Override
    public News getOneNews(int idNews) throws DAOException {
        News news = null;
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    @Override
    public boolean approvedNews(int[] massIdNews) throws DAOException {
